...
int rgb[] = {9, 10, 11};
int buzzer = 6;
int segments[] = {3, 4, 5, 7, 8, 12, 13, A1};
...
void displayNumber(int number)
{
  ...
  for(int i = 0; i < 8; i++)
    digitalWrite(segments[i], numberSignals[number][i]);

}

void getRandomColorRGB()
{
  analogWrite(rgb[0], random(0, 255));
  analogWrite(rgb[1], random(0, 255));
  analogWrite(rgb[2], random(0, 255));
}
