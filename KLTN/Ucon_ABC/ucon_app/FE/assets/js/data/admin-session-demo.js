...
(function(){
  ...
  pushUnique('PIP_ATTRIBUTE_MAPPINGS', [
    {attr_key:'object.preview_limit_pages',xacml_attribute_id:'object.preview_limit_pages',xacml_category:'resource',xacml_data_type:'integer',reader_name:'previewLimitReader',writer_name:'',dependency_name:'SYSTEM_PARAMETERS.preview_limit_pages',monitor_type:'none',mutable:'false',enabled:'true'},
    {attr_key:'environment.current_page',xacml_attribute_id:'environment.current_page',xacml_category:'environment',xacml_data_type:'integer',reader_name:'currentPageReader',writer_name:'',dependency_name:'SESSION_EVENTS.current_page',monitor_type:'timer',mutable:'true',enabled:'true'},
    {attr_key:'subject.volume_purchase',xacml_attribute_id:'subject.volume_purchase',xacml_category:'subject',xacml_data_type:'boolean',reader_name:'volumePurchaseReader',writer_name:'',dependency_name:'VOLUME_PURCHASES.volume_id',monitor_type:'event',mutable:'true',enabled:'true'}
  ]);
